...
public class ScoreboardServiceProducer {
    ...
    Optional<String> cosmosdbUri = Optional.of("localhost://3454353434-2323-24be-2342-222c5ebadb61:NpxCEjVIe82NW3RnHxoVeD2iBUpfFOHdVRXnDpRo3oxMm3sdg==@asdf8c-81d0");
